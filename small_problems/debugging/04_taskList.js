...
// removing elements while iterating over an array is always a tricky endeavor
// I have instead logged all of the elements to be deleted then removed them.
// we could also remove the tasks to be marked complete into their own array, 
// then iterate through that array logging each one.

// Course Solution
// use Array.shift() to remove the first element in the array on each loop.