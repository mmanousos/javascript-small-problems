...
// my solution - I understood only modern art if in Amsterdam
// also comparison operators should be on preceding line to avoid confusion
  return museum.includes('Computer') ||
        museum.includes('Science') ||
        museum.includes('Andy Warhol') ||
        (museum.includes('Modern') &&
...
// Course Solution - interprets specifications slightly differently - they understood Modern Art if Warhol or Amsterdam
return  museum.includes('Computer')
  ||  museum.includes('Science')
  ||  (museum.includes('Modern')
    && museum.includes('Art')
...
// we want computer, science, Andy Warhol, or + Modern + Art + Amsterdam
