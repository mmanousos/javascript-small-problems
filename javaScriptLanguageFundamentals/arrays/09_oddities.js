...
Answer:
Since `oddities()` returns a new array, the two arrays being compared are not
pointing to the same object in memory. So even though they contain the same
values, the comparisons return false.
